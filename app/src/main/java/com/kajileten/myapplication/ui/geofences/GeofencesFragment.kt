...
class GeofencesFragment : Fragment() {
    ...
    private val geofencesViewModel: GeofencesViewModel by viewModels()

    private val geofencesAdapter by lazy { GeofencesAdapter(sharedViewModel, geofencesViewModel)}
